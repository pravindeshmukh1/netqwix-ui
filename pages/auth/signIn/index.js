...
const Auth_SignIn = () => {
  ...
  const Login = (email, password) => {
    ...
    if (localStorage.getItem("email") === "test@gmail.com" && localStorage.getItem("password") === "test123") {
      setTimeout(() => {
              ...
              <div className="left-page">
                <div className="login-content">
                  <div className="login-content-header">
                    <Link href="/landing">
                      <img className="image-fluid" src="/assets/images/logo/landing-logo.png" alt="images" />
                    </Link>
                  </div>
                  ...
                  <form className="form1">
                    <div className="form-group">
                      ...
                      <input className="form-control" id="inputEmail3" value={credential.email} onChange={(e) => handleChange(e)} name="email" type="email" placeholder="Demo@123gmail.com" />
                    </div>
                    <div className="form-group">
                      ...
                      <span> </span>
                      <input className="form-control" id="inputPassword3" defaultValue={credential.password} onChange={(e) => handleChange(e)} name="password" type="password" placeholder="*******" />
                    </div>
                    <div className="form-group">
                      <div className="rememberchk">
                        <div className="input-text form-check pl-0">
                          <input type="checkbox" id="gridCheck1" aria-label="Checkbox for following text input" />
                          <label className="form-check-label ml-2 mr-auto" htmlFor="gridCheck1">
                            Remember Me.
                          </label>
                    ...
                    <div className="form-group">
                      <div className="buttons">
                        <Link className="btn btn-primary button-effect" href="#" onClick={() => Login(credential.email, credential.password)}>
                          Login
                        </Link>
                        <Link className="btn button-effect btn-signup" href="#" onClick={() => redirectToSignUpPage()}>
                          SignUp
                        </Link>
                      </div>
                    </div>

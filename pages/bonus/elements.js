						...
						<Row>
							<Col xs="12">
								<div className="element-card element-badge">
									...
									<div className="element-card-body typography">
										<Link className="badge badge-outline-primary font_label" href="#">label-primary</Link>
										<Link className="badge badge-success font_label" href="#">label-success</Link>
									</div>
								</div>
							</Col>
						</Row>
						...
						<Row>
							<Col xs="12">
								<div className="element-card">
									...
									<div className="element-card-body typography">
										<div className="fonts">
											<Link className="icon-btn btn-primary button-effect" href="#">
												<Circle />
											</Link>
											<Link className="icon-btn btn-success button-effect" href="#">
												<Users />
											</Link>
											<Link className="icon-btn btn-danger button-effect" href="#">
												<Star />
											</Link>
											<Link className="icon-btn btn-light button-effect" href="#">
												<Star />
											</Link>
											<Link className="icon-btn btn-warning button-effect" href="#">
												<Star />
											</Link>
											<Link

...
import {getTraineeWithSlotsAsync, traineeState} from '../trainee/trainee.slice';
import SocialMediaIcons from '../../common/socialMediaIcons';
import {Utils} from '../../../utils/utils';
import ImageVideoThumbnailCarousel
  ...
  return (
    <div className="custom-sidebar-content">
      {trainerInfo === null
        ...
        : <div
            className={`${(trainerInfo.isCategory && !trainerDetails.select_trainer && 'media-body media-body text-right') || (!trainerInfo.isCategory && 'media-body media-body text-right')}`}
          >
            <div className="mr-4 mt-4">
    ...
    () => {
      if (trainer && trainer.extraInfo) {
        setAccordionsData (prev => ({
          ...
          credentials_and_affiliations: trainer.extraInfo
  ...
  return (
    <div className="row px-20 py-10">
      <div className="col-5">
        ...
        {trainer && trainer.extraInfo && trainer.extraInfo.social_media_links
          ? <SocialMediaIcons
              social_media_links={
                trainer &&
                  trainer.extraInfo &&

...
const MultiRangeSlider = ({startTime, endTime, onChange}) => {
  ...
  return (
    <div className="range-slider-container">
      ...
      <div className="range-slider">
        ...
        <div className="slider__left-value">{minutesToTime (minVal)}</div>
        <div className="slider__right-value">{minutesToTime (maxVal)}</div>
      </div>
    </div>
  );
};

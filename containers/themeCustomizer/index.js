...
const ThemeCustomizer = () => {
  ...
  const { toggleSmallSide } = useContext(ChatContext);
  ...
  const handleLayoutType = (layouts) => {
    ...
    } else if (toggleSmallSide) {
      setLayout(!layouts);
      addLayoutType("back-main-page main-page");
      config.layout_type = "back-main-page main-page";
    } else {
      setLayout(!layouts);
      addLayoutType("");
      config.layout_type = "";
        ...
        <div className="color-picker">
          ...
          <ul className="colors">
            <li
              ...
              onClick={(e) => colorChangeTheme(e, "style")}></li>
            <li
              className="color1"
              onClick={(e) => colorChangeTheme(e, "style1")}></li>
            <li
              className="color2"
              onClick={(e) => colorChangeTheme(e, "style2")}></li>
            <li
              className="color3"
              onClick={(e) => colorChangeTheme(e, "style3")}></li>
            <li
              className="color4"
              onClick={(e) => colorChangeTheme(e, "style4")}></li>
            <li
              className="color5"
              onClick={(e) => colorChangeTheme(e, "style5")}></li>
            <li
              className="color6"
              onClick={(e) => colorChangeTheme(e, "style6")}></li>
          </ul>
        </div>
        ...
        <div className="chat-wallpaper">
          ...
          <ul className="wallpaper">
            <li
              ...
              onClick={(e) => setBackgroundWallpaper(e, 0)}></li>
            <li

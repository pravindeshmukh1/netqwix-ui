...
import { bookingsAction, bookingsState } from '../../app/components/common/common.slice';
					...
					{!configs.sidebar.isToggleEnable ? '' : <>
						...
						>
							...
							<Link
								...
								className={`icon-btn ml-3 button-effect pull-right mainnav  ${sidebarToggle ? 'btn-outline-primary' : 'btn-outline-light'}`}
								href="#"

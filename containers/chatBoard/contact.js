...
const Contact = () => {
    ...
    return (
        <div className="contact-content tabto">
          <div className="contact-sub-content"><Link className="icon-btn btn-outline-primary button-effect mobile-back mb-3" href="#" onClick={() => handleClickRight(mainMenu)}><i className="ti-angle-left"></i></Link>
            <div className="row">
              <div className="col-sm-5">
                <div className="user-profile">
                  <div className="user-content"><img className="img-fluid bg-icon" src="/assets/images/contact/2.jpg" alt="user-img"/>
                    <h3>Josephin water</h3>
                    <ul> 
                      <li><i className="fa fa-twitch"> </i>massage</li>
                      <li><i className="fa fa-phone"> </i>voice call</li>
                ...
                <div className="personal-info-group">
                  <div className="social-info-group">
                    <ul className="integratin mt-0">
                      <li>
                        <div className="media">
                          <div className="media-left"><Link className="fb" href="https://www.facebook.com/login" target="_blank">
                              <i className="fa fa-facebook mr-1"></i>
                              <h5> Facebook   </h5></Link></div>
                      ...
                      <li>
                        <div className="media">
                          <div className="media-left"><Link className="twi" href="https://twitter.com/login" target="_blank">
                            <i className="fa fa-twitter mr-1"></i>
                              <h5> twitter   </h5></Link></div>
                          <div className="media-right">
                      ...
                      <li>
                        <div className="media">
                          <div className="media-left"><Link className="ggl" href="https://accounts.google.com/signin/v2/identifier?service=mail&amp;passive=true&amp;rm=false&amp;continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&amp;ss=1&amp;scc=1&amp;ltmpl=default&amp;ltmplcache=2&amp;emr=1&amp;osid=1&amp;flowName=GlifWebSignIn&amp;flowEntry=ServiceLogin" target="_blank">
                            <i className="fa fa-google mr-1"></i>
                              <h5>google   </h5></Link></div>
                          <div className="media-right">

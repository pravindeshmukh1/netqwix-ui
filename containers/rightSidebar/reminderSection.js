      ...
      <div className="reminder-main">
        ...
        <div className="reminder-content tab-card ">
          ...
          <Modal
            ...
            toggle={() => setReminderModal(!reminderModal)}
            className="reminder-modal-main add-popup show"
            centered={true}
          >
            ...
            <ModalBody>
              <form className="form default-form">
                ...
                <div className="reminder-btn">
                  <Button
                    className=" btn-primary button-effect"
                    onClick={() => setReminderModal(!reminderModal)}
                  >
                    set reminder
                  </Button>
        ...
        <div className="reminder-list-disp">
          ...
          <ul className="reminder-disp">
            <li className="reminder-list-toggle">
              <Link className="icon-btn bg-transparent" href="#">
                <MoreVertical />
              </Link>
              <div className="reminder-contentlist-toggle">
                <ul>
                  <li>
                    <Link className="icon-btn btn-sm" href="#">
                      <Trash />
                    </Link>
                    <h5>Delete</h5>
                  </li>
        ...
        <div className="reminder-list">
          <button
            className={`Show-reminder ${showCompletedToggle ? "" : "d-none"}`}
            onClick={() => setShowCompetdToggle(!showCompletedToggle)}
          >
            Show Completed
          </button>
          <button
            className="Hide-reminder"
            style={
              showCompletedToggle
                ? { display: "none" }
          ...
          <div
            className="target-reminder-list"
            style={
              showCompletedToggle ? { display: "none" } : { display: "block" }
            }
          >
            <h5>Session Start</h5>
            <h6>Project Discussion</h6>
